<template>
  <div class="login">
    ...
    <p>Forgot Password? Click <router-link to="/share-forgot-password">HERE</router-link> </p>
  </div>
</template>
...
export default {
  ...
  `${import.meta.env.VITE_APP_BASE_URL}/auth/share-login`,
  {
    email: this.email,
  ...
  token,
        ...
        this.$router.push(`/share-profile/${member.memberId}`);
      } catch (error) {
